...
namespace COMP2084Assignment.Controllers
{
    ...
    public class PlatformsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Developer,ReleaseDate")] Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Developer,ReleaseDate")] Platform platform)
        {
            if (id != platform.Id)
            {
                return NotFound();
